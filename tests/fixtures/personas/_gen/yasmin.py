...
def _e7_band_crossing() -> dict:
    ...
    return {
        ...
        "expect": (
            ...
            "row is free text - `value` is numeric and every string field "
            "is an ISO date or a closed vocabulary - and no consumer "
            "surface bundled with this engine (`vitai crossings`, its JSON "
            "form, the MCP tool) prints one either. "
            "`docs/medical-boundary.md` class (a) - a bound "
