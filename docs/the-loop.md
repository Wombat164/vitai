...
193. So how many calories is 1 kg for me? - not the textbook 7,700 (that assumes 100% fat). Calibrated from the fat/lean split of your actual loss it lands nearer ~6,000-6,500 kcal per scale-kg for a well-run cut. Naive cumulative-deficit-vs-scale-weight math can spit out a five-figure kcal/kg - nonsense, because a holiday plateau corrupts scale weight while the deficit keeps booking. [G36, calibration]
